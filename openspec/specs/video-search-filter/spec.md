# video-search-filter Specification

## Purpose
Search results can exclude videos on demand: an `excludeVideos` API flag backed by a filterable, backfilled `mime_type` field and a URL-persisted search-page toggle.
